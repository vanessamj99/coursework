...
```
#ratings_by_movie <- ratings %>% group_by(movie_id) %>% summarize(num_ratings = n())
#ratings_mean = mean(ratings_by_movie$num_ratings)
#ratings_mean
#936.5977
...
ggplot(aes(x = count)) + geom_histogram() + scale_x_log10() + xlab("number of ratings per movie") + ylab("number of movies")
